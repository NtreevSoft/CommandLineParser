...
//{
//    class GitUsageDescriptionProvider : IUsageDescriptionProvider
//    {
//        private readonly static Dictionary<Type, ResourceSet> resourceSets = new Dictionary<Type, ResourceSet>();

//        static GitUsageDescriptionProvider()
//        {

//        }

//        public GitUsageDescriptionProvider()
//        {
...
//            {
//                var stream = typeof(Program).Assembly.GetManifestResourceStream(type.FullName + ".resources");
